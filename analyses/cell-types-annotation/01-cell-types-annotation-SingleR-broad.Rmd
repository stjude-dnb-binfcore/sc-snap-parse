---
title: "Cell types annotation with SingleR using a broad resolution reference for sc-/sn-RNA-Seq Analysis in PARSE BIOSCIENCES sequencing technology data"
...
First, we will use the object as generated from the pipeline in the `r input_data` module. 
