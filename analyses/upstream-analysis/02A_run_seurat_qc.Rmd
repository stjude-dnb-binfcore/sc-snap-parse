...
source(paste0(analysis_dir, "/util/generate_QC_Plots_sublib_ID.R"))
```
...
seurat_obj$sublib_ID <- sub(".*__([^_]+)$", "\\1", rownames(seurat_obj@meta.data))

# Let's use the ordered list with the sublib_ID to map s1, s2, … → our ordered list and replace accordingly.
...
# Keep original
seurat_obj$sublib_ID_original <- seurat_obj$sublib_ID

# Map new IDs
idx <- as.integer(sub("s", "", seurat_obj$sublib_ID_original))
seurat_obj$sublib_ID <- sublib_list_file$V1[idx]
# head(seurat_obj@meta.data)
seurat_obj$sublib_ID <- factor(seurat_obj$sublib_ID)
# Optional check
head(seurat_obj@meta.data[, c("sublib_ID_original", "sublib_ID")])
...
sublib_ids <- unique(as.character(seurat_obj$sublib_ID))
sublib_ids <- sort(sublib_ids, decreasing = FALSE)
print(sublib_ids)
...
for (x in sublib_ids) {
  ...
  seurat_obj_sub <- subset(seurat_obj, subset = sublib_ID == x)
  
  fname <- file.path(sublibrary_samples_plots_dir, sprintf("%s", x), sprintf("%s_01_before_filter_vln_plot_sublibrary.png", x))
  p <- print(create_vln_plot(seurat_obj = seurat_obj_sub, grouping = "sublib_ID", min_genes = min_genes, min_count = min_count, title_name = paste("Unfiltered-data:", sample_name[i], x), palette = palette_df))
  ggsave(filename = fname, plot = p, width = 8, height = 6, device = "png")

  print(Generate_QC_Plots_1_sublib_ID(Seurat_obj = seurat_obj_sub, Project_Path = sublibrary_samples_plots_dir, Figure_Total = "02", Analysis_Name = sprintf("%s", x), File_Name = "QC_Raw_Data_sublibrary", palette = gradient_palette_df))
  print(Generate_QC_Plots_2_sublib_ID(Seurat_obj = seurat_obj_sub, Project_Path = sublibrary_samples_plots_dir, Figure_Total = "03", Analysis_Name = sprintf("%s", x), File_Name = "QC_Raw_Data_sublibrary", palette = gradient_palette_df))
  print(Generate_QC_Plots_3_sublib_ID(Seurat_obj = seurat_obj_sub, Project_Path = sublibrary_samples_plots_dir, Figure_Total = "04", Analysis_Name = sprintf("%s", x), File_Name = "QC_Raw_Data_sublibrary", palette = gradient_palette_df))
  print(Generate_QC_Plots_4_sublib_ID(Seurat_obj = seurat_obj_sub, Project_Path = sublibrary_samples_plots_dir, Figure_Total = "05", Analysis_Name = sprintf("%s", x), File_Name = "QC_Raw_Data_sublibrary", palette = gradient_palette_df))
  print(Generate_QC_Plots_5_sublib_ID(Seurat_obj = seurat_obj_sub, Project_Path = sublibrary_samples_plots_dir, Figure_Total = "06", Analysis_Name = sprintf("%s", x), File_Name = "QC_Raw_Data_sublibrary", palette = gradient_palette_df))
  print(Generate_QC_Plots_6_sublib_ID(Seurat_obj = seurat_obj_sub, Project_Path = sublibrary_samples_plots_dir, Figure_Total = "07", Analysis_Name = sprintf("%s", x), File_Name = "QC_Raw_Data_sublibrary", palette = gradient_palette_df))
}
```
...
for (x in sublib_ids) {
  ...
  p <- print(create_vln_plot(seurat_obj = seurat_obj_sub, grouping = "sublib_ID", min_genes = min_genes, min_count = min_count, title_name = paste("Filtered-data:", sample_name[i], x), palette = palette_df))
  ggsave(filename = fname, plot = p, width = 8, height = 6, device = "png")

  print(Generate_QC_Plots_1_sublib_ID(Seurat_obj = seurat_obj_sub, Project_Path = sublibrary_samples_plots_dir, Figure_Total = "08", Analysis_Name = sprintf("%s", x), File_Name = "QC_Filtered_Data_sublibrary", palette = gradient_palette_df))
  print(Generate_QC_Plots_2_sublib_ID(Seurat_obj = seurat_obj_sub, Project_Path = sublibrary_samples_plots_dir, Figure_Total = "09", Analysis_Name = sprintf("%s", x), File_Name = "QC_Filtered_Data_sublibrary", palette = gradient_palette_df))
  print(Generate_QC_Plots_3_sublib_ID(Seurat_obj = seurat_obj_sub, Project_Path = sublibrary_samples_plots_dir, Figure_Total = "10", Analysis_Name = sprintf("%s", x), File_Name = "QC_Filtered_Data_sublibrary", palette = gradient_palette_df))
  print(Generate_QC_Plots_4_sublib_ID(Seurat_obj = seurat_obj_sub, Project_Path = sublibrary_samples_plots_dir, Figure_Total = "11", Analysis_Name = sprintf("%s", x), File_Name = "QC_Filtered_Data_sublibrary", palette = gradient_palette_df))
  print(Generate_QC_Plots_5_sublib_ID(Seurat_obj = seurat_obj_sub, Project_Path = sublibrary_samples_plots_dir, Figure_Total = "12", Analysis_Name = sprintf("%s", x), File_Name = "QC_Filtered_Data_sublibrary", palette = gradient_palette_df))
  print(Generate_QC_Plots_6_sublib_ID(Seurat_obj = seurat_obj_sub, Project_Path = sublibrary_samples_plots_dir, Figure_Total = "13", Analysis_Name = sprintf("%s", x), File_Name = "QC_Filtered_Data_sublibrary", palette = gradient_palette_df))
}
```
