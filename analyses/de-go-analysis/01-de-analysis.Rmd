---
title: "Differential expression (DE) Per Cell Type for sc-RNA-Seq Analysis in PARSE BIOSCIENCES sequencing technology data"
...
write.table(all.markers, file = paste(results_dir, "/", cell_type_label_go, "_cell_type", "_Markers_all.tsv", sep = ""), sep = "\t", quote = FALSE, row.names = FALSE)
```
...
write.table(all.markers_condition_value1, file = paste(results_dir, "/", cell_type_label_go, "_cell_type", "_Markers_all_condition_value1.tsv", sep = ""), sep = "\t", quote = FALSE, row.names = FALSE)
```
...
if (!is.null(condition_value2)) {
  ...
  write.table(all.markers_condition_value2, file = paste(results_dir, "/", cell_type_label_go, "_cell_type", "_Markers_all_condition_value2.tsv", sep = ""), sep = "\t", quote = FALSE, row.names = FALSE)
}
```
...
if (!is.null(condition_value3)) {
  ...
  write.table(all.markers_condition_value3, file = paste(results_dir, "/", cell_type_label_go, "_cell_type", "_Markers_all_condition_value3.tsv", sep = ""), sep = "\t", quote = FALSE, row.names = FALSE)
}
```
