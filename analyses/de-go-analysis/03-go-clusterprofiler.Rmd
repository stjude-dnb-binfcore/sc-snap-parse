---
title: "Gene Ontology (GO) enrichment analysis using clusterProfiler per cell type for sc-RNA-Seq Analysis in PARSE BIOSCIENCES sequencing technology data"
...
markers_file_overall <- file.path(markers_dir_module, glue::glue("{cell_type_label_go}_cell_type_Markers_all.tsv"))
markers_file_condition_value1 <- file.path(markers_dir_module, glue::glue("{cell_type_label_go}_cell_type_Markers_all_condition_value1.tsv"))
markers_file_condition_value2 <- file.path(markers_dir_module, glue::glue("{cell_type_label_go}_cell_type_Markers_all_condition_value2.tsv"))
markers_file_condition_value3 <- file.path(markers_dir_module, glue::glue("{cell_type_label_go}_cell_type_Markers_all_condition_value3.tsv"))
